...
describe('stateFromElement', function () {
  it('should create content state', function () {
    ...
    (0, _expect2.default)(rawContentState).toEqual({ entityMap: {}, blocks: [{ data: {}, text: 'Hello World', type: 'unstyled', depth: 0, inlineStyleRanges: [], entityRanges: [] }] });
  });
  ...
  it('supports custom element styles option', function () {
    ...
    var rawContentState = removeBlockKeys((0, _draftJs.convertToRaw)(contentState));
    (0, _expect2.default)(rawContentState).toEqual({ entityMap: {}, blocks: [{ data: {}, text: 'Superscript', type: 'unstyled', depth: 0, inlineStyleRanges: [{ offset: 0, length: 11, style: 'SUPERSCRIPT' }], entityRanges: [] }] });
  });

  it('supports custom style option', function () {
    var textNode = new _syntheticDom.TextNode('text');
    var element = new _syntheticDom.ElementNode('span', [['style', 'color: red; background-color: blue;']], [textNode]);
    ...
    var contentState = (0, _stateFromElement2.default)(wrapperElement, options);
    var rawContentState = removeBlockKeys((0, _draftJs.convertToRaw)(contentState));
    (0, _expect2.default)(rawContentState).toEqual({ entityMap: {}, blocks: [{ data: {}, text: 'text', type: 'unstyled', depth: 0, inlineStyleRanges: [{ offset: 0, length: 4, style: 'RED' }, { offset: 0, length: 4, style: 'BLUEBG' }], entityRanges: [] }] });
  });
});
